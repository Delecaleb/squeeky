...
//                       ],
//                     ),
//                     appController.businessCategory.length <1 ? Text("Loadinggggg") :
//                     Obx(() {
//                       print(" my output here ${appController.businessCategory[1].storeImage}");
                      
//                         return ListView.builder(
//                           itemCount: appController.businessCategory.length,
//                           itemBuilder: (context, index){
//                             final category = appController.businessCategory[index];
//                             return Text(category.storeImage);
//                           }
//                           );
