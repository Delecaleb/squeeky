class ContactModel {
  ...
  factory ContactModel.fromJson(Map<String, dynamic> mapData){
    return ContactModel( lastMessage:mapData['last_message_content'].toString(),dateBooked: mapData['created_at'],serviceStatus: mapData['service_status'] ,businessCity: mapData['business_city'].toString(), businessLogo: mapData['business_logo'], businessName: mapData['business_name'], businessId:mapData['business_id']);
  }
}