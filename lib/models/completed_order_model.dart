class CompletedOrderModel{
  String businessName, imagePath, total, dateCompleted, serviceCharge, subTotal, businessId;
  
  final List<CompletedServiceModel> servicesOfferedList;
  
  CompletedOrderModel({required this.businessId, required this.subTotal ,required this.businessName, required this.imagePath, required this.serviceCharge, required this.dateCompleted, required this.total, required this.servicesOfferedList});
  ...
  factory CompletedOrderModel.fromJson(Map<String, dynamic>mapData){
    ...
    return CompletedOrderModel(businessId:mapData['business_id'], subTotal:mapData['sub_total'] ,businessName: mapData['business_name'], imagePath: mapData['cover_image'], total: mapData['total'], servicesOfferedList: services, dateCompleted:mapData['date_completed'], serviceCharge:mapData['service_fee'].toString());
  }
